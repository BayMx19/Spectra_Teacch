...
<div class="container-xxl flex-grow-1 container-p-y px-4">
    <div class="row g-6">
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header text-bold mt-3 mb-3">Edit Sub Lesson</h5>
                <div class="card-body">
                    <form action="{{ route('master_sub_lessons.update', $subLesson->id) }}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" class="form-control" id="title" required
                                value="{{ old('title', $subLesson->title) }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="order" class="form-control" id="order" min="1" required
                                value="{{ old('order', $subLesson->order) }}">
                        </div>

                        <div class="mb-4">
                            <label for="use_table_data" class="form-label">Gunakan Table Data?</label>
                            <select name="use_table_data" id="use_table_data" class="form-control">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="use_image" id="use_image" class="form-control">
